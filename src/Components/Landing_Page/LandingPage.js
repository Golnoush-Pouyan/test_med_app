    ...
    <section className="hero-section"> {/* Creating a section with class name 'hero-section' */}
      <div>
        <div data-aos="fade-up" className="flex-hero"> {/* Creating a div with data-aos attribute and class name 'flex-hero' */}
            ...
            <div className="blob-cont"> {/* Changed 'class' to 'className' */}
              <div className="blue blob"></div> {/* Changed 'class' to 'className' */}
            </div>

            <div className="blob-cont"> {/* Changed 'class' to 'className' */}
              <div className="blue1 blob"></div> {/* Changed 'class' to 'className' */}
            </div>
            ...
            <Link to="#services"> {/* Replaced 'a' with 'Link' component for smooth scrolling */}
              <button className="button">Get Started</button> {/* Changed 'class' to 'className' */}
            </Link>
        </div>
      </div>
    </section>
